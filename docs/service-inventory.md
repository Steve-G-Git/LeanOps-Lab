...
| 68 | UDP | VM network interfaces | `systemd-networkd` DHCP client | Not evaluated as a listening server | Required for current address assignment |
...
The final Nmap scan found TCP port 22 open and 999 commonly scanned TCP ports closed.
